...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # 设置绝对路径
        script1_path = r"D:\MetaBCI\py_api\neuracle_py_api\example_online_read_data.py"
        script2_path = r"D:\MetaBCI\demos\brainstim_demos\stim_demo.py"
        script3_path = r"D:\MetaBCI\demos\brainstim_demos\stim_demoo.py"
